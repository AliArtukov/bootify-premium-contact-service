# Bootify Premium Contact Service
...
```
java -Dspring.profiles.active=production -jar ./target/bootify-premium-contact-service-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bootify-premium-contact-service
```
